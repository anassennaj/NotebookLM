        ...
        <div className="border-b border-border flex-shrink-0">
          <Accordion type="single" value={accordionValue} onValueChange={setAccordionValue} collapsible>
            <AccordionItem value="guide" className="border-0">
              <AccordionTrigger 
                className="px-4 py-3 text-sm font-medium hover:no-underline hover:bg-primary/10" 
                  ...
                  {citation.source_type === 'website' && sourceUrl && (
                    <div>
                      ...
                      <a 
                        ...
                        className="text-[#0088c2] hover:text-[#006a99] hover:underline break-all text-sm"
                      >
                        {sourceUrl}
                      </a>
                    </div>
