        ...
        <div className="space-y-4">
          <div>
            <p className="text-sm text-gray-600 mb-4">
              Cette boîte de dialogue lit automatiquement votre presse-papiers. Vous pouvez également coller manuellement du contenu ci-dessous.
            </p>
          </div>
          ...
          <div className="flex justify-end space-x-2 pt-4">
            ...
            >
              {isSubmitting ? 'Ajout en cours...' : 'Ajouter le texte'}
            </Button>
          </div>
        </div>
      </DialogContent>
