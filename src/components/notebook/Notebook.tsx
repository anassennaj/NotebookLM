...
const Notebook = () => {
  ...
  return (
    <div className="h-screen bg-background flex flex-col overflow-hidden">
      <NotebookHeader 
        title={notebook?.title || 'Carnet sans titre'} 
      ...
      {isDesktop ? (
        ...
        <div className="flex-1 flex overflow-hidden">
          <div className={`${sourcesWidth} flex-shrink-0 border-r border-border`}>
            <SourcesSidebar 
          ...
          <div className={`${studioWidth} flex-shrink-0 border-l border-border`}>
            <StudioSidebar 
              notebookId={notebookId} 
              onCitationClick={handleCitationClick}
            />
